...
def opendb():
    subprocess.call(["grunt", "--gruntfile", "/home/niles/Documents/odk/app-designer/Gruntfile.js", "adbpull"])
    import sqlite3
    return sqlite3.connect("/home/niles/Documents/odk/app-designer/app/output/db/webDb/sqlite.db")
